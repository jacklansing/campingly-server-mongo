...
export class CampsiteGearMigration1600794066013 implements MigrationInterface {
    name = 'CampsiteGearMigration1600794066013'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "campsite" ("id" SERIAL NOT NULL, "name" text NOT NULL, "counselorId" integer NOT NULL, "startingDate" TIMESTAMP NOT NULL, "endingDate" TIMESTAMP NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_2fdd619b3981a8e68f3601c3d32" PRIMARY KEY ("id"))`);
